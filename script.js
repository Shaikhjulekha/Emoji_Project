...
const displaySearchResult = (searchQuery = "") =>{
    ...
    filtered.forEach(e=>{
        ...
        new_aliases.innerText = new_aliases.innerText.replace('_' ," ");

        new_emoji.classList.add("emoji");
        new_aliases.classList.add("alises");
...
window.onload = ()=> displaySearchResult();
